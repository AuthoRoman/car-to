...
const regions: { [key: string]: string } = {
  ...
  function decodeVIN(vin: string): VINInfo | null {
    ...
    const manufacturer = manufacturers[vin.substring(0, 3)] || "Неизвестный производитель";
    const vehicleAttributes = vin.substring(3, 8); // Детализация по характеристикам автомобиля
