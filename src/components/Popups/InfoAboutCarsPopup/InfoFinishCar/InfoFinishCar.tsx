          ...
          >
            <li className={styles.InfoWaitingPopup__innerPoints}>
              <span className={styles.titlePoints}>
                Завод по сборке данного
                автомобиля.........................................
              </span>
              <span className={styles.valueOfPoints}>{car.assemblyPlant}</span>
            </li>
            <li className={styles.InfoWaitingPopup__innerPoints}>
              <span className={styles.titlePoints}>
                Номер контрольный
            ...
            <li className={styles.InfoWaitingPopup__innerPoints}>
              <span className={styles.titlePoints}>
                Имя мастера, который отремонтировал
                авто...........................
              </span>
